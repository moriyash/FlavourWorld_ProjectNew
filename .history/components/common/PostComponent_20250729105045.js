...
const PostComponent = ({ 
  ...
  const [showEditModal, setShowEditModal] = useState(false); // 🆕 מודל עריכה
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      if (isActualGroupPost && effectiveGroupId) {
        result = await groupService.updateGroupPost(effectiveGroupId, postId, {
          ...editData,
          userId: currentUserId
        });
      } else {
        result = await recipeService.updateRecipe(postId, {
          ...editData,
          userId: currentUserId
        });
      }
        ...
        <ScrollView style={styles.editModalContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.editRowContainer}>
            <View style={styles.editHalfField}>
              <Text style={styles.editLabel}>Prep Time (min)</Text>
              <TextInput
                style={styles.editInput}
                value={editData.prepTime.toString()}
                onChangeText={(text) => setEditData(prev => ({...prev, prepTime: parseInt(text) || 0}))}
                placeholder="30"
                placeholderTextColor={FLAVORWORLD_COLORS.textLight}
          ...
          <View style={styles.editRowContainer}>
            ...
            <View style={styles.editHalfField}>
              <Text style={styles.editLabel}>Meat Type</Text>
              <TextInput
                style={styles.editInput}
                value={editData.meatType}
                onChangeText={(text) => setEditData(prev => ({...prev, meatType: text}))}
                placeholder="Chicken"
                placeholderTextColor={FLAVORWORLD_COLORS.textLight}
                maxLength={30}
              />
           ...
           {/* בחירת סוג מדיה */}
          <View style={styles.editField}>
            <Text style={styles.editLabel}>Media Type</Text>
            <View style={styles.mediaTypeContainer}>
              <TouchableOpacity
                style={[
                  styles.mediaTypeButton,
                  editMediaType === 'none' && styles.activeMediaTypeButton
                ]}
                onPress={() => handleMediaTypeChange('none')}
              >
                <Ionicons 
                  name="ban-outline" 
                  size={20} 
                  color={editMediaType === 'none' ? FLAVORWORLD_COLORS.white : FLAVORWORLD_COLORS.textLight} 
                />
                <Text style={[
                  styles.mediaTypeText,
                  editMediaType === 'none' && styles.activeMediaTypeText
                ]}>None</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                style={[
                  styles.mediaTypeButton,
                  editMediaType === 'image' && styles.activeMediaTypeButton
                ]}
              ...
              >
                <Ionicons 
                  name="image-outline" 
                  size={20} 
                  color={editMediaType === 'image' ? FLAVORWORLD_COLORS.white : FLAVORWORLD_COLORS.textLight} 
                />
                <Text style={[
                  styles.mediaTypeText,
                  editMediaType === 'image' && styles.activeMediaTypeText
                ]}>Image</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                style={[
                  styles.mediaTypeButton,
                  editMediaType === 'video' && styles.activeMediaTypeButton
                ]}
              ...
              >
                <Ionicons 
                  ...
                  size={20} 
                  color={editMediaType === 'video' ? FLAVORWORLD_COLORS.white : FLAVORWORLD_COLORS.textLight} 
                />
                <Text style={[
                  styles.mediaTypeText,
                  editMediaType === 'video' && styles.activeMediaTypeText
                ]}>Video</Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          {editMediaType === 'image' && (
            <View style={styles.editField}>
              ...
              {editData.image ? (
                ...
                <TouchableOpacity style={styles.editMediaButton} onPress={handleImagePick}>
                  <Ionicons name="camera-outline" size={24} color={FLAVORWORLD_COLORS.primary} />
                  <Text style={styles.editMediaButtonText}>Select Image</Text>
                </TouchableOpacity>
              )}
            </View>
          )}
          ...
          {editMediaType === 'video' && (
            <View style={styles.editField}>
              <Text style={styles.editLabel}>Recipe Video</Text>
              {editData.video ? (
                <View style={styles.editMediaPreview}>
                  <Video
                ...
                <TouchableOpacity style={styles.editMediaButton} onPress={handleVideoPick}>
                  <Ionicons name="videocam-outline" size={24} color={FLAVORWORLD_COLORS.primary} />
                  <Text style={styles.editMediaButtonText}>Select Video</Text>
                </TouchableOpacity>
              )}
            </View>
          )}
