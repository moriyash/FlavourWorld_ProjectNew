...
<View style={styles.editRowContainer}>
    ...
    <View style={styles.editDropdown}>
      <Picker
        ...
        onValueChange={(itemValue) =>
          setEditData(prev => ({ ...prev, category: itemValue }))
        }
        style={styles.editDropdownInput}
        dropdownIconColor={FLAVORWORLD_COLORS.textLight}
      >
        <Picker.Item label="Select cuisine" value="" enabled={false} />
        {categories.map((item) => (
  ...
  <View style={styles.editHalfField}>
    ...
    <View style={styles.editDropdown}>
      <Picker
        selectedValue={editData.meatType}
        onValueChange={(itemValue) =>
          setEditData(prev => ({ ...prev, meatType: itemValue }))
        }
        style={styles.editDropdownInput}
        dropdownIconColor={FLAVORWORLD_COLORS.textLight}
      >
