...
<View style={styles.editRowContainer}>
  ...
  <View style={styles.editHalfField}>
    ...
    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.editDropdown}>
      {categories.map((category) => (
        <TouchableOpacity
          key={category}
          style={[
            styles.filterChip,
            editData.category === category && styles.activeFilterChip
          ]}
          onPress={() => setEditData(prev => ({ ...prev, category }))}
        >
          <Text
            style={[
              styles.filterChipText,
              editData.category === category && styles.activeFilterChipText
            ]}
          >
    ...
    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.editDropdown}>
      {meatTypes.map((meatType) => (
        <TouchableOpacity
          ...
          style={[
            styles.filterChip,
            editData.meatType === meatType && styles.activeFilterChip
          ]}
          onPress={() => setEditData(prev => ({ ...prev, meatType }))}
        >
          <Text
            style={[
              styles.filterChipText,
              editData.meatType === meatType && styles.activeFilterChipText
            ]}
          >
