    ...
    try {
      ...
      for (const contact of selectedContactsData) {
        try {
          ...
          // 🆕 שליחת הודעת מתכון מיוחדת
          const sendResult = await chatService.sendMessage(
            chatId,
            JSON.stringify(recipeMessageData), // שליחת כל הנתונים כ-JSON
            'shared_recipe',
            'private'
          );
          ...
          <View style={styles.previewTextContainer}>
            ...
            <View style={styles.previewMeta}>
              <Text style={styles.previewMetaText}>
                ⏱️ {post.prepTime || 0}min • 👥 {post.servings || 0} servings
              </Text>
              <Text style={styles.previewCategory}>
                📂 {post.category || 'General'} • 🥘 {post.meatType || 'Mixed'}
              </Text>
            </View>
          </View>
        </View>
