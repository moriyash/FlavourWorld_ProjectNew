  ...
  <View style={styles.createPostContainer}>
    ...
    <View style={styles.createPostActions}>
      ...
      <TouchableOpacity 
        ...
        onPress={() => setShowCreateModal(true)}
      >
        <Ionicons name="videocam-outline" size={20} color={FLAVORWORLD_COLORS.info} />
        <Text style={styles.createPostButtonText}>Video</Text>
      </TouchableOpacity>
    </View>
  </View>
...
const styles = StyleSheet.create({
  ...
  createPostActions: {
  flexDirection: 'row',
  justifyContent: 'space-around', // שנה מ-space-around ל-space-between אם יש 3 כפתורים
  paddingTop: 12,
  borderTopWidth: 1,
  borderTopColor: FLAVORWORLD_COLORS.border,
},
createPostButton: {
  ...
  alignItems: 'center',
  paddingVertical: 8,
  paddingHorizontal: 12, // הקטן מ-16 ל-12 כדי שיכנסו 3 כפתורים
  backgroundColor: FLAVORWORLD_COLORS.background,
  borderRadius: 15,
  borderWidth: 1,
  borderColor: FLAVORWORLD_COLORS.border,
  flex: 1, // הוסף את זה
  marginHorizontal: 4, // הוסף מרווח בין הכפתורים
},
