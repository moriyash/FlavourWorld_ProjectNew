...
export const recipeService = {
  ...
  try {
    ...
    // 🆕 בדיקה למדיה (תמונה או וידאו או image ישן)
    const hasMedia = recipeData.media || recipeData.image;
    const mediaType = recipeData.mediaType || (recipeData.image ? 'image' : 'none');
    ...
    if (hasMedia) {
      ...
      const mediaUri = recipeData.media || recipeData.image;
