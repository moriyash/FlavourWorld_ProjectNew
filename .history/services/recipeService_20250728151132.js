...
export const recipeService = {
  ...
  try {
    ...
    if (hasMedia) {
      ...
      formData.append('userName', recipeData.userName || recipeData.name || 'Anonymous Chef');
      formData.append('userAvatar', recipeData.userAvatar || '');
      formData.append('mediaType', mediaType);
// בתחילת פונקציית createRecipe, לפני יצירת FormData
if (!recipeData.userName || recipeData.userName.trim() === '') {
  recipeData.userName = 'Anonymous Chef';
  console.log('⚠️ Fixed missing userName');
}
