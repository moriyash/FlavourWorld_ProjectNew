  ...
  const renderEditModal = () => (
    ...
    >
      <SafeAreaView style={styles.editModalContainer}>
        ...
        <ScrollView style={styles.editModalContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.editRowContainer}>
            <View style={styles.editHalfField}>
              ...
              >
                <Text style={[
                  styles.editDropdownInput,
                  !editData.category && { color: FLAVORWORLD_COLORS.textLight }
                ]}>
                  {editData.category || 'Select cuisine'}
                </Text>
            ...
            <View style={styles.editHalfField}>
              ...
              <TouchableOpacity
                style={styles.editDropdown}
                onPress={() => setShowEditMeatTypeModal(true)}
              >
                <Text style={[
                  styles.editDropdownInput,
                  !editData.meatType && { color: FLAVORWORLD_COLORS.textLight }
                ]}>
                  {editData.meatType || 'Select type'}
                </Text>
                <Ionicons name="chevron-down" size={20} color={FLAVORWORLD_COLORS.textLight} />
              </TouchableOpacity>
            </View>
        ...
        {/* Category Modal */}
        <Modal visible={showEditCategoryModal} animationType="slide" transparent={true}>
              ...
              <FlatList
                ...
                renderItem={({ item }) => (
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      setEditData(prev => ({...prev, category: item}));
        ...
        {/* Meat Type Modal */}
        <Modal visible={showEditMeatTypeModal} animationType="slide" transparent={true}>
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              <View style={styles.modalHeader}>
                <Text style={styles.modalTitle}>Select Type</Text>
                <TouchableOpacity onPress={() => setShowEditMeatTypeModal(false)}>
                  <Ionicons name="close" size={24} color={FLAVORWORLD_COLORS.accent} />
                </TouchableOpacity>
              </View>
              <FlatList
                ...
                renderItem={({ item }) => (
                  <TouchableOpacity
                    style={styles.modalItem}
                    onPress={() => {
                      setEditData(prev => ({...prev, meatType: item}));
                      setShowEditMeatTypeModal(false);
                    }}
                  >
                    <Text style={styles.modalItemText}>{item}</Text>
                  </TouchableOpacity>
